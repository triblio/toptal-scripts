...
(function(window, document){
  ...
  // Stolen from pardot tracking script
  ...
  window.trDocReady(function(){
    ...
    var trackAsAd = function(){
      ...
      if(queryVariables && queryVariables.tr_ad_clickthrough){
        var obj = {};

        if(queryVariables && queryVariables.tr_g_id) obj.gtrid = queryVariables.tr_g_id;

        if(queryVariables && queryVariables.p) obj.p = queryVariables.p;
        if(queryVariables && queryVariables.ca) obj.ca = queryVariables.ca;
        if(queryVariables && queryVariables.sm) obj.sm = queryVariables.sm;
        track(AD_CLICK, obj);
      }
    };
